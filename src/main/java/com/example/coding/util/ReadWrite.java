...
public class ReadWrite {
    ...
    public static Set<Player> readData() {
        ...
        try {
            ...
            //System.out.println();
            //System.out.println("Set size : " + list.size() + " ,Set  : " + list);
        } catch (Exception e) {
    ...
    public static String getJson(Player p) {
        return "{ \"pName\" : " +"\""+ p.getpName() +"\""+" ,\"pHealth\" : " + p.getpHealth() + " ,\"pGold\" : " + p.getpGold()
                +",\"pEnergyDrink\" : " + p.getpEnergyDrink() +" ,\"pShortGun\" : " + p.getpShortGun() +" ,\"pBigGun\" : " + p.getpBigGun()
                +",\"eName\" : " +"\""+ p.geteName() +"\""+" ,\"eHealth\" : " + p.geteHealth() + " ,\"eGold\" : " + p.geteGold()
                +",\"eEnergyDrink\" : " + p.geteEnergyDrink() +" ,\"eShortGun\" : " + p.geteShortGun() +" ,\"eBigGun\" : " + p.geteBigGun()
